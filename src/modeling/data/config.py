...
folder_path = join(MODELS_PATH, "handrefiner/")
JOINT_REGRESSOR_TRAIN_EXTRA = folder_path + 'J_regressor_extra.npy'
JOINT_REGRESSOR_H36M_correct = folder_path + 'J_regressor_h36m_correct.npy'
SMPL_FILE = folder_path + 'basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
SMPL_Male = folder_path + 'basicModel_m_lbs_10_207_0_v1.0.0.pkl'
SMPL_Female = folder_path + 'basicModel_f_lbs_10_207_0_v1.0.0.pkl'
SMPL_sampling_matrix = folder_path + 'mesh_downsampling.npz'
